...
function Header () {
    return (
        <div>
            ...
            <div style = {{backgroundColor: "lightgrey", height:"50px",width: "100%", marginTop: "70% ", position: "fixed", display: "flex"}}>
                <AiFillHome style = {{height: "20px", width: "20px",  marginTop: "15px", marginLeft: "40%" , cursor: "pointer"}}></AiFillHome>
